...
def create_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="TextKit: A toolkit for text processing."
    )
    ...
    analyze_parser.add_argument(
        "--input", help="Path to the input text file.", type=str
    )
    analyze_parser.add_argument(
    ...
    # transform_parser.add_argument("--operation", help="", choices=["email", "phone", "date", "url"], required=True)
